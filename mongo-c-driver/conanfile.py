...
class MongoCDriverConan(ConanFile):
    ...
    license = "Apache-2.0"
    exports = ["LICENSE.md", "ssl-targets.patch"]
    ...
    def source(self):
        remote = "https://github.com/mongodb/mongo-c-driver/releases/download/{0}/mongo-c-driver-{0}.tar.gz"
        sha256 = "ad479a6d3499038ec19ca80a30dfa99277644bb884e424362935b06e2d5f7988"
        tools.get(remote.format(self.version), sha256=sha256)
